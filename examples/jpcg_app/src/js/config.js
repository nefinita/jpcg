...
export const XINFA_LIST = [
  { value: 'yin_long_jue', label: '隐龙诀', icon: '🐉' },
  { value: 'wufang', label: '无方', icon: '🌀' },
  { value: 'cang_jian', label: '藏剑山庄', icon: '⚔️' },
  { value: 'qi_xiu', label: '七秀坊', icon: '💃' },
  { value: 'wan_hua', label: '万花谷', icon: '🌸' },
  { value: 'tian_ce', label: '天策府', icon: '🛡️' },
  { value: 'shao_lin', label: '少林寺', icon: '👊' },
  { value: 'chun_yang', label: '纯阳观', icon: '☯️' },
  { value: 'wu_du', label: '五毒教', icon: '🐍' },
  { value: 'tang_men', label: '唐门', icon: '🎯' },
  { value: 'ming_jiao', label: '明教', icon: '🔥' },
  { value: 'gai_bang', label: '丐帮', icon: '🍶' },
  { value: 'cang_yun', label: '苍云', icon: '🦅' },
  { value: 'mowen', label: '莫问', icon: '🎵', default: true },
  { value: 'ba_dao', label: '霸刀山庄', icon: '🗡️' },
  { value: 'peng_lai', label: '蓬莱', icon: '🏝️' },
  { value: 'yan_tian', label: '衍天宗', icon: '🔮' },
  { value: 'yao_zong', label: '药宗', icon: '🌿' },
];
